...
import rocket from '../assets/wmsl.png'
import Avatar from '../assets/Avatar.jpeg';
import wave from '../assets/waves-white.svg'
import ivancik from '../assets/ivancik.jpg'
import { App } from '../components/charts/chart';
import { Linechart } from '../components/charts/lineChart';
import user1 from '../assets/user_images/team-1.jpg'
import user2 from '../assets/user_images/team-2.jpg'
import user3 from '../assets/user_images/team-3.jpg'
import user4 from '../assets/user_images/team-4.jpg'
...
const Dashboard2 = () => {
  ...
  console.log(queryGetUSER?.data?.data?.data.length,"kkkkkkkkkkkkkkkkkkkkkkkkkk")
  useEffect(() => {
    window.scrollTo({
      top: 0,
      left: 0,
    ...
    setUserCount(queryGetUSER?.data?.data?.data.length)
    }, [queryGetUSER]);
    ...
    return (
        // cards
        <div className='w-full px-6 py-6 mx-auto min-h-screen'>
            {/* card row 1 */}
                        ...
                        <div className="flex-auto p-4">
                            <div className="flex flex-row -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p className="mb-0 font-sans font-semibold leading-normal text-md">Subscribed Users</p>
                                        <h5 className="mb-0 font-bold">
                                            {userCount}
                                            <span className="leading-normal text-sm font-weight-bolder text-lime-500">+50%</span>
                                        </h5>
                                    </div>
                                </div>
                                <div className="px-3 text-right basis-1/3">
                                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-[#dddd23] to-[#16884d]">

                                        <BiCoinStack className='text-lg relative top-3.5 text-white inline-block mb-3' />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-row -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p className="mb-0 font-sans font-semibold leading-normal text-md">Number of Users</p>
                                        <h5 className="mb-0 font-bold">
                                        {userCount}
                                ...
                                <div className="px-3 text-right basis-1/3">
                                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-[#dddd23] to-[#16884d]">
                                        ...
                                        <TiWorld className='text-lg relative top-3.5 text-white mb-5 inline-block' />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-row -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p className="mb-0 font-sans font-semibold leading-normal text-sm">Unsubscribed Users</p>
                                        <h5 className="mb-0 font-bold">
                                            +3,462
                                ...
                                <div className="px-3 text-right basis-1/3">
                                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-[#dddd23] to-[#16884d]">
                                        <IoNewspaper className='text-lg relative top-3.5 text-white mb-5 inline-block' />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-row -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p className="mb-0 font-sans font-semibold leading-normal text-md">Tournament list</p>
                                        <h5 className="mb-0 font-bold">
                                ...
                                <div className="px-3 text-right basis-1/3">
                                    <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-[#dddd23] to-[#16884d]">
                                        ...
                                        <CiShoppingCart className='text-lg relative top-3.5 text-white mb-5 inline-block' />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-wrap -mx-3">
                                <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                                    <div className="flex flex-col h-full">
                                        ...
                                        <h5 className="font-bold">DynamoChess</h5>
                                        <p className="mb-2">
                                            From colors, cards, typography to complex elements, you will
                                            find the full documentation.
                                        </p>
                                        <a
                                            className="mt-auto mb-12 max-sm:mb-3 font-semibold leading-normal text-sm group text-slate-500"
                                            href="javascript:;"
                                        >
                                            Read More
                                ...
                                <div className="max-md:w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                                    <div className=" h-full bg-gradient-to-tl from-[#dddd23] to-[#16884d] rounded-xl">
                                        <img
                                            src={wave}
                                        ...
                                        <div className="relative flex items-center justify-center h-full">
                                            <img
                                                className="relative z-20 w-28 h-36 pt-6 pb-1"
                                                src={rocket}
                                                alt="rocket"
                                            />
                                        </div>
                    ...
                    <div className="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col flex-auto h-full p-4">
                                <h5 className="pt-2 mb-2 font-bold text-white">
                                Vision
                                </h5>
                                <p className="text-white md:leading-5">
                                We intend to start a competition for our new game of Dynamic Chess, with participants from inter club, educational institution & others. The tournaments will go from city & state level and then global level.
                                </p>
                                <a
            ...
            {/* card row-3 */}
            <div className=" hidden flex-wrap mt-6 -mx-3">
                {/* card-col-1 */}
            ...
            {/* card row-4 */}
            <div className="flex flex-wrap ms-[230px] max-sm:ms-0 max-md:ms-0 mx-2 mt-6 ">
        {/* card 1 */}
        
        <div className=" w-full  mt-0 mb-6 md:mb-0 md:flex-none  lg:flex-none">
          <div className="border-black/12.5 shadow-soft-xl flex min-w-0 flex-col break-words rounded-2xl  border-solid bg-white bg-clip-border">
            <div className="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
              <div className="flex flex-wrap mt-0 -mx-3">
                <div className="flex-none max-w-full  px-3 mt-0 ">
                  <h6 className='font-semibold  text-xl'>Users</h6>
                  <p className="mb-0 leading-normal text-md">
                    <i className="fa fa-check text-green-600" />
                    <span className="ml-1 font-semibold">30 users </span>
                    this month
                  </p>
                </div>
            ...
            <div className="flex-auto p-4 px-0 pb-2">
              <div className="overflow-x-auto ">
                <table className="items-center w-full md:w-full mb-0 align-top border-gray-200 text-slate-500">
                  <thead className="align-bottom border-y">
                    <tr className=''>
                      <th className="px-6 max-sm:px-3 py-3 font-bold tracking-normal text-left text-sm max-sm:text-xs  uppercase align-middle bg-transparent border-b letter border-b-solid  whitespace-nowrap border-b-gray-200 text-slate-600 opacity-70">
                        Images
                      </th>
                      <th className="px-6 max-sm:px-3 py-3  font-bold tracking-normal text-center text-sm max-sm:text-xs  uppercase align-middle bg-transparent border-b letter border-b-solid  whitespace-nowrap border-b-gray-200 text-slate-600 opacity-70">
                        Username
                      </th>
                      <th className="px-6 max-sm:px-3 py-3 font-bold tracking-normal text-center text-sm max-sm:text-xs uppercase align-middle bg-transparent border-b letter border-b-solid  whitespace-nowrap border-b-gray-200 text-slate-600 opacity-70">
                        Joining Date
                  ...
                  <tbody>
                    <tr>
                      <td className="p-1.5 align-middle bg-transparent border-b px-6 max-sm:px-3 text-left  whitespace-nowrap">
                        <div className="flexpy-1">
                          <div>
                            <img
                              src={Avatar}
                              className="inline-flex items-center  justify-center ms-2 text-white transition-all duration-200 ease-soft-in-out text-sm h-9 w-9 rounded-full"
                              alt="xd"
                            />
                          </div>
        ...
        {/* card 2 */}
        {/* <div className="w-full  px-3 md:w-full md:flex-none lg:w-1/3 lg:flex-none">
              ...
              <div className="before:border-r-solid relative before:absolute before:top-0 before:left-4 before:h-full before:border-r-2 before:border-r-slate-100 before:content-[''] before:lg:-ml-px">
                <div className="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    ...
                    <i className="fa-solid fa-bell relative z-10 text-transparent ni leading-none ni-bell-55 leading-pro bg-gradient-to-tl from-green-600 to-lime-400 bg-clip-text fill-transparent"></i>
                  </span>
                  <div className="ml-12 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                ...
                <div className="relative mb-4 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    <i className="relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-red-600 to-rose-400 bg-clip-text fill-transparent" />
                    <i className="fa-brands fa-html5 relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-red-600 to-rose-400 bg-clip-text fill-transparent"></i>
                ...
                <div className="relative mb-4 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    <i className="relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text fill-transparent" />
                    <i className="fa-solid fa-cart-shopping relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text fill-transparent"></i>
                  </span>
                  <div className="ml-12 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                    <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">
                ...
                <div className="relative mb-4 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    <i className="relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-red-500 to-yellow-400 bg-clip-text fill-transparent" />
                    <i className="fa-solid fa-credit-card relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-red-500 to-yellow-400 bg-clip-text fill-transparent"></i>
                  </span>
                  <div className="ml-12 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                    <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">
                ...
                <div className="relative mb-4 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    <i className="relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text fill-transparent" />
                    <i className="fa-solid fa-key relative z-10 text-transparent ni leading-none  leading-pro bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text fill-transparent"></i>
                  </span>
                  <div className="ml-12 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                    <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">
                ...
                <div className="relative mb-0 after:clear-both after:table after:content-['']">
                  <span className="w-6.5 h-6.5 text-base absolute left-4 z-10 inline-flex -translate-x-1/2 items-center justify-center rounded-full bg-white text-center font-semibold">
                    <i className="relative z-10 text-transparent ni leading-none leading-pro bg-gradient-to-tl from-gray-900 to-slate-800 bg-clip-text fill-transparent" />
                    <i className="fa-solid fa-coins relative z-10 text-transparent ni leading-none leading-pro bg-gradient-to-tl from-gray-900 to-slate-800 bg-clip-text fill-transparent"></i>
                  </span>
                  <div className="ml-12 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                    <h6 className="mb-0 font-semibold leading-normal text-sm text-slate-700">
                      New order #9583120
