    ...
    const handleImageUpload = (event) => {
        ...
        if (file) {
          ...
          reader.onloadend = () => {
            setImg((prevdata) => ({
              ...prevdata,  
              tournamentimg: reader.result 
            }));
          };
          reader.readAsDataURL(file);
          setFormData((prevFormData) => ({
            ...prevFormData,
            tournamentimg: file // Update only the images field in formData
          }));
        }
      };
      ...
      const handleSaveData = async (e) => {
        const url = `${import.meta.env.VITE_URL}${import.meta.env.VITE_SETABOUTTOURNAMENT}`
        e.preventDefault();
      ...
      console.log(queryGetselectedContent.data?.data?.data, "pppppppppppppppp");
    ...
    <div>
      ...
      <div className='w-full'>
        ...
        <div className='text-center  shadow-lg rounded-md mt-2 mb-1 py-4 '>
            <h1 className=' font-bold text-2xl text-[#16884d]'>About Tournament</h1>
          </div>
        </div>
      </div>
      <div className='w-full'>
         <div className='flex flex-wrap mx-3'>
            <div className='w-full mt-6 pl-1 max-sm:-ml-2 px-2'>
                ...
                <p className='text-2xl font-semibold py-2'>Set About Tournament Details</p>
              </div>
        ...
        />
                    ...
                    <div className='w-full lg:w-4/12 max-sm:mt-4 px-3 inline-flex items-center  justify-center'>
                    <select 
                      name="title"
                   value={formData.title}
                    ...
                    className='text-sm px-1 text-center w-full overflow-x-auto font-semibold border-2 rounded-md py-2 '
                     >
                          ...
                          <option>Indian Council For Cultural Relation</option>
                          <option>Chess Tournaments</option>
                          <option>Section Of Tournaments</option>
                     </select>
                  </div>
                </div>
      ...
      <div className='w-full'>
          <div className='flex flex-wrap mx-3'>
            <div className='w-full mt-6 pl-1 max-sm:mx-2 px-2'>
              <div className='relative flex flex-col p-2 pb-6 h-full min-w-0 break-words bg-white border-0 shadow-xl rounded-md bg-clip-border'>
                <div className='text-center rounded-md bg-gray-300'>
                  <p className='text-2xl font-semibold py-2'>About Tournament Details</p>
                </div>
