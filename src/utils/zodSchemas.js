...
export const contentSchema = z.object({
  title: z.string().min(3, { message: "Title should be at least three characters long" }),
  content: z.string().min(3, { message: "Content should be at least three characters long" }),
  images: z.any().optional(), // or z.string().optional() if you expect a string
});